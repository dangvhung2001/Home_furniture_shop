...
import com.example.quanlydogiadinh.repository.EmployeeRepository;
import com.example.quanlydogiadinh.repository.RoleRepository;
import com.example.quanlydogiadinh.service.EmployeeService;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeDTO save(EmployeeDTO employeeDTO) {
        ...
        String body = "Xin chào "+ employee.getName() + ",\n\n" +
...
//                employeeDTO.setStartDate(existingEmployee.getStartDate());
    ...
    public void exportExcel(HttpServletResponse response) throws IOException {
        ...
        String[] columns = {"ID nhân viên", "Họ và tên", "Địa chỉ", "Ngày sinh", "Giới tính", "SĐT", "Chức vụ", "Email", "Lương cơ bản", "Ảnh", "Trạng thái"};
...
//            row.createCell(8).setCellValue(employee.getSalary(Salary));
            row.createCell(9).setCellValue(employee.getImgUrl());
            row.createCell(10).setCellValue(employee.getStatus());
